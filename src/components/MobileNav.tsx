    ...
    <>
      ...
      />
       ...
       <aside
         ...
         className={`fixed right-0 top-0 z-[81] flex h-[100dvh] w-[88%] max-w-sm flex-col overflow-hidden bg-white text-foreground shadow-[0_0_60px_-10px_rgba(0,0,0,0.2)] transition-transform duration-300 ease-out lg:hidden ${
       ...
       >
        ...
        <nav className="relative flex-1 overflow-y-auto px-3 py-4">
          ...
          <div className="mt-6 px-3">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 px-3">
             <Link
               to="/portal-cliente"
               onClick={() => setOpen(false)}
               className="flex w-full items-center justify-center gap-2 rounded-2xl border border-brand-gold/40 bg-brand-gold/10 py-3.5 text-brand-gold transition-colors hover:bg-brand-gold/15"
             >
